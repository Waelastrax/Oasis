...
function setupScene(host: HTMLDivElement, onSelect: (hex: SelectionInfo | null) => void, onCameraModeChange: (mode: CameraMode) => void, onConfirmSelection: () => void) {
  ...
  const cloudPlane = new THREE.Mesh(new THREE.PlaneGeometry(112, 112), new THREE.MeshBasicMaterial({ map: cloudField.texture, transparent: true, opacity: 0.74, depthTest: false, depthWrite: false, side: THREE.DoubleSide }));
